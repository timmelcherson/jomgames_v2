<template>
  <div class="rajnd-item">
    ...
    <textarea
      v-model="answerData"
      class="textarea-input no-padding height-40"
      :style="{ margin: '4px' }"
      :class="{ 'no-border': !isEditingMode }"
      :disabled="!isEditingMode"
    />
    ...
    <div class="actions-row">
      <button v-if="isEditingMode" @click="editQuestion" class="action-done-btn">Klar</button>
